    ...
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 px-3 pb-[calc(0.45rem+env(safe-area-inset-bottom))] pt-1.5 shadow-[0_-16px_45px_rgba(20,33,38,0.12)] backdrop-blur-xl sm:hidden">
      <div className="grid grid-cols-3 gap-2">
        {phoneHref ? (
          <a
            href={phoneHref}
            className="focus-ring inline-flex min-h-11 flex-col items-center justify-center gap-1 rounded-xl bg-loden-fog px-2 text-xs font-bold text-loden-ink"
          >
        ...
        {whatsappHref ? (
          <a
            href={whatsappHref}
            className="focus-ring inline-flex min-h-11 flex-col items-center justify-center gap-1 rounded-xl bg-[#25D366] px-2 text-xs font-bold text-white"
          >
        ...
        <Link
          href="/inscription"
          className="focus-ring inline-flex min-h-11 flex-col items-center justify-center gap-1 rounded-xl bg-loden-700 px-2 text-xs font-bold text-white"
        >
