  ...
  return (
    <div className="grid gap-5">
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Card className="p-4">
          <p className="text-xs font-semibold uppercase tracking-[0.12em] text-loden-muted">Tâches ouvertes</p>
          <p className="mt-1 text-2xl font-bold text-loden-ink">{counts.tasks}</p>
        </Card>
      </div>
      ...
      {appointments.length === 0 ? (
        ...
        <div className="grid gap-4">
          {appointments.map((appointment) => {
            ...
            const conversation = conversations.find((item) => item.appointmentId === appointment.id);
            return (
